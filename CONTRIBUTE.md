# Contribute
If you want to contribute source code to perlbsc then please read this document, it describes how to
contribute your code to perlbsc.
...
This is to ensure that we can keep perlbsc open source for everyone.
